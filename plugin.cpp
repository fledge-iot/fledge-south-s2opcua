...
static const char *default_config = QUOTE({
    ...
    "controlList" : {
        "description" : "A list of node IDs for the OPC UA variables that may be written via the plugin.",
        "type" : "list",
        "items" : "string",
        "default" : "[]",
...
{
    Logger::getLogger()->warn("OPC UA plugin does not support Setpoint control operation");
    return false;
}
